...
function setColor() {
  ...
  for (let i = 0; i < 24; i++) {
    particleMaterial[i].color.setRGB(
      normalizedRed,
      normalizedGreen,
      normalizedBlue
    );
...
const pointLight = new THREE.PointLight(red, 1, 500);
pointLight.position.set(50, 50, 50);
scene.add(pointLight);

// Para um efeito mais suave e distribuído, você pode adicionar luz ambiente
